...
//			this._transformMatrix.rawData[3] = this._flarSource.sourceSize.width - this._transformMatrix.rawData[3];
		...
		private function dumpSpeeds (sd:int=4) :String {
			return (
				"[2D] "+ this.motionSpeed2D.toFixed(sd) +"\u0009"+"\u0009"+
				"[Z] "+ this.velocity.z.toFixed(sd) +"\u0009"+"\u0009"+
				"[rX] "+ this.rotationSpeeds.x.toFixed(sd) +"\u0009"+"\u0009"+
				"[rY] "+ this.rotationSpeeds.y.toFixed(sd) +"\u0009"+"\u0009"+
				"[rZ] "+ this.rotationSpeeds.z.toFixed(sd) +"\u0009"+"\u0009"
			);
		}
